...
The model has an error and does not execute.
Compiling model...
...
% This script was autogenerated with ModelClass v0.4.7 a5ec716   -   Fernando Nóbel (fersann1@upv.es).
...
m = 
  ...
  importModel with properties:
    ...
    varsIndexNoNegative: []
            ...
            symbolsName: {'x1'  'x2'  'x3'  'k1'  'k2'  'k3'  'd1'  'd2'  'd3'  'gamma12'  'eq_0'  'eq_1'  'eq_2'  'ref'  'eq_3'}
                symbols: {1x15 cell}
